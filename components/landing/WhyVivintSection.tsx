...
function trackPhoneClick() {
  if (typeof window !== 'undefined') {
    ...
    dl?.push({ event: 'phone_click', source: 'why_vivint' })
  }
}

export default function WhyVivintSection({ onQuizOpen, callMode }: WhyVivintSectionProps) {
